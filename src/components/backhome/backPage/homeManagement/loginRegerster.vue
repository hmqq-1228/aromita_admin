      ...
      <div class="draCont">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px">
          ...
          <el-form-item label="上传图片" prop="imageUrl">
            ...
            <div class="tip"><i class="el-icon-warning-outline"></i> 请上传不超过500KB的940*530尺寸的PNG、JPG、JPEG格式图片!</div>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods:{
      // 获取banner列表
      getBannerListFuc () {
        getBannerList ({position:60}).then((res)=>{
      ...
      toBannerDetail (id) {
        ...
        this.$axios.get(`backend/home/${id}`,{}).then((res)=>{
          ...
          if (res.data.code === 200) {
            ...
            if (res.data.data.position === 60) {
              this.DetailPosion = '登录注册图'
            }
