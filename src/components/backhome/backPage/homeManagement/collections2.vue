<template>
  <div class="banner">
    <div class="header">
      <div>首页collections副图(最多添加4个)</div>
      ...
      <div class="draCont">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px">
          ...
          <el-form-item label="上传图片" prop="imageUrl">
            ...
            <div class="tip"><i class="el-icon-warning-outline"></i> 请上传不超过500KB的460*300尺寸的PNG、JPG、JPEG格式图片!</div>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods:{
      // 获取banner列表
      getBannerListFuc () {
        getBannerList ({position:20}).then((res)=>{
      ...
      addNew () {
        ...
        this.isEdit = false
        this.bntStr = '立即创建'
        this.bannerTitle = '新建Collections副图'
      ...
      bannerEdit (id) {
        ...
        that.isEdit = true
        that.bntStr = '确定修改'
        that.bannerTitle = '修改Collections副图'
      ...
      toBannerDetail (id) {
        ...
        this.$axios.get(`backend/home/${id}`,{}).then((res)=>{
          ...
          if (res.data.code === 200) {
            ...
            if (res.data.data.position === 20) {
              this.DetailPosion = 'Collection'
            }
