      ...
      <div class="draCont">
        <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px">
          ...
          <el-form-item label="上传图片" prop="imageUrl">
            ...
            <div class="tip"><i class="el-icon-warning-outline"></i> 请上传不超过500KB的360*36尺寸的PNG、JPG、JPEG格式图片!</div>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    methods:{
      // 获取banner列表
      getBannerListFuc () {
        getBannerList ({position:70}).then((res)=>{
      ...
      toBannerDetail (id) {
        ...
        this.$axios.get(`backend/home/${id}`,{}).then((res)=>{
          ...
          if (res.data.code === 200) {
            ...
            if (res.data.data.position === 70) {
              this.DetailPosion = '底部支付方式'
            }
